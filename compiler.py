...
def_attrib = str_9 | agi_7 | int_5 | cha_7
...
DEFAULT_ITEM_MODIFIERS = [
    ...
    ("fine",        "Fine %s",          1.100000, 0.600000), # +1 damage
    ...
    ("exquisite",   "Exquisite %s",     8.500000, 0.300000), # No effects.
    ("masterwork",  "Masterwork %s",   10.500000, 0.300000), # +5 damage,                   +1 speed, +4 prerequisite
