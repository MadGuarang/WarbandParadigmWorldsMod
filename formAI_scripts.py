  ...
  ("field_tactics", [
	...
	(try_for_range, ":ai_team", 0, 4),
		...
		(try_begin),
			...
			(this_or_next|eq, ":ai_faction", fac_order_le),	
			(this_or_next|eq, ":ai_faction", fac_order_fl),	
			(this_or_next|eq, ":ai_faction", fac_order_tdo),	
			(this_or_next|eq, ":ai_faction", fac_order_dig),	
			(this_or_next|eq, ":ai_faction", fac_order_cb),	
			(this_or_next|eq, ":ai_faction", fac_order_unk),	
			(this_or_next|eq, ":ai_faction", fac_lost_legion),	
			(this_or_next|eq, ":ai_faction", fac_old_gods),	
			(this_or_next|eq, ":ai_faction", fac_techno_mages),	
			(this_or_next|eq, ":ai_faction", fac_stargate),	
			(this_or_next|eq, ":ai_faction", fac_doomsday_cultists),	
			(this_or_next|eq, ":ai_faction", fac_undeads),	
			(this_or_next|eq, ":ai_faction", fac_deserters),	#deserters have military training
...
formAI_replacement_scripts = [# # Line added to clear scripted mode right before each (agent_start_running_away, ":cur_agent")
