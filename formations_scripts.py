...
# #Formations Scripts	  
  ...
  ("get_default_formation", [
	...
	(try_begin),
		(eq, ":ffaction", fac_kingdom_1),	#Morlok
		(assign, reg0, formation_ranks),
	(else_try),
		(eq, ":ffaction", fac_kingdom_2),	#Weimear
		(assign, reg0, formation_wedge),
	(else_try),
		(eq, ":ffaction", fac_kingdom_3),	#Alien
		(assign, reg0, formation_ranks),	
	(else_try),
		(eq, ":ffaction", fac_kingdom_4),	#Fantasy
		(assign, reg0, formation_ranks),
	(else_try),
		(eq, ":ffaction", fac_kingdom_5),	#Renaissance
		(assign, reg0, formation_shield),
	(else_try),
		(eq, ":ffaction", fac_kingdom_6),	#Conspiracy
		(assign, reg0, formation_ranks),
	(else_try),
		(eq, ":ffaction", fac_manhunters),	#manhunters
		(assign, reg0, formation_ranks),
	(else_try),
		(eq, ":ffaction", fac_mountain_bandits),	#scoias
		(assign, reg0, formation_ranks),
	(else_try),
		(eq, ":ffaction", fac_doomsday_cultists),	#doomsday_cultists
		(assign, reg0, formation_ranks),
	(else_try),
		(eq, ":ffaction", fac_weimear_rebellion),	#deithwen_brigade
		(assign, reg0, formation_wedge),
	(else_try),
		(eq, ":ffaction", fac_stargate),	#stargate
		(assign, reg0, formation_ranks),
	(else_try),
		(eq, ":ffaction", fac_techno_mages),	#techno_mages
		(assign, reg0, formation_ranks),
	(else_try),
		(eq, ":ffaction", fac_old_gods),	#old_gods
		(assign, reg0, formation_wedge),
	(else_try),
		(eq, ":ffaction", fac_undeads),	#techno_mages
		(assign, reg0, formation_wedge),
	(else_try),
		(eq, ":ffaction", fac_lost_legion),	#lost_legion
		(assign, reg0, formation_shield),
	(else_try),
		(eq, ":ffaction", fac_crazy_pikt),	#crazy_pikt
		(assign, reg0, formation_wedge),
	(else_try),
		(eq, ":ffaction", fac_crazy_pikt),	#crazy_pikt
		(assign, reg0, formation_wedge),
	(else_try),
		(eq, ":ffaction", fac_desert_abominations),	#desert_abominations
		(assign, reg0, formation_wedge),	
	(else_try),
	    (this_or_next|eq, ":ffaction", fac_player_supporters_faction),
